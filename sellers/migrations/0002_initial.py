...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sellerverificationdocument',
            name='reviewed_by',
        ...
        migrations.AddField(
            model_name='sellerverificationdocument',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='verification_documents', to='sellers.sellerprofile'),
        ),
    ]
